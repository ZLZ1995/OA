...
文档版本：1.0；核对日期：2026-09-17。代码基线：`58aa5698035e884231db4c745e7a8e776d7ff173`（含 PR #155、#156）。
...
本手册发布到 GitHub **不会自动注入内置客服的提示词或知识库**。外部 agent 可以直接读取本手册；若要内置客服自动使用，需要另外实现受控知识加载/检索并测试，不应仅凭新增 Markdown 宣称客服已经升级。
