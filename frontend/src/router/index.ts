...
const routes: RouteRecordRaw[] = [
  { path: '/login', component: () => import('@/views/auth/LoginView.vue') },
  {
    ...
    children: [
      ...
      { path: 'oa-agent', component: () => import('@/views/agent/OaAgentView.vue') },
      ...
      { path: 'help/overview', component: () => import('@/views/help/HelpOverviewView.vue') },
      { path: 'help/business-flow', component: () => import('@/views/help/HelpBusinessFlowView.vue') },
      { path: 'help/role-flow', component: () => import('@/views/help/HelpRoleFlowView.vue') },
      { path: 'help/manual', component: () => import('@/views/help/HelpManualView.vue') },
