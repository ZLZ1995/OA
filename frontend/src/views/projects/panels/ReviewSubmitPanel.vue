...
const REVIEW_STATUS_TEXT: Record<string, string> = {
  ...
  CONTRACT_PROCESS_COMPLETED: '合同流程已办结，待上传待审报告',
...
function isSubmitStatus(status: string) {
  return ['CONTRACT_APPROVED', 'CONTRACT_PROCESS_COMPLETED', 'WAIT_FIRST_REVIEW_SUBMIT', 'FIRST_REVIEW_REJECTED', 'FIRST_APPROVED_WAIT_LEADER_SUBMIT_SECOND', 'FIRST_APPROVED_WAIT_FIRST_SELECT_SECOND', 'WAIT_SECOND_REVIEW_SUBMIT', 'SECOND_REVIEW_REJECTED', 'SECOND_APPROVED_WAIT_LEADER_SUBMIT_THIRD', 'SECOND_APPROVED_WAIT_SECOND_SELECT_THIRD', 'WAIT_THIRD_REVIEW_SUBMIT', 'THIRD_REVIEW_REJECTED', 'WAIT_EXTERNAL_FIRST_REVIEW_SUBMIT', 'EXTERNAL_FIRST_REJECTED', 'EXTERNAL_FIRST_APPROVED_WAIT_RECALL_OR_SECOND', 'WAIT_EXTERNAL_SECOND_REVIEW_SUBMIT', 'EXTERNAL_SECOND_REJECTED', 'EXTERNAL_SECOND_APPROVED_WAIT_RECALL_OR_THIRD', 'WAIT_EXTERNAL_THIRD_REVIEW_SUBMIT', 'EXTERNAL_THIRD_REJECTED'].includes(status)
}
